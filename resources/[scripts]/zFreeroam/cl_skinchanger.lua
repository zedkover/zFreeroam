local Components = {
	...
	{label = "Visage peds 1",					name = 'facepeds',				value = 0,		min = 0,	zoomOffset = 0.6,		camOffset = 0.65},
	{label = "Visage peds 2",					name = 'facepeds2',				value = 0,		min = 0,	zoomOffset = 0.6,		camOffset = 0.65},

	{label = "Largeur nez",					name = 'Largeurnez',				value = 0,		min = 0,	zoomOffset = 0.6,		camOffset = 0.65},
	{label = "Hauteur nez",					name = 'Hauteurnez',				value = 0,		min = 0,	zoomOffset = 0.6,		camOffset = 0.65},
	{label = "Longueur nez",					name = 'Longueurnez',				value = 0,		min = 0,	zoomOffset = 0.6,		camOffset = 0.65},
	{label = "Abaissement du nez",					name = 'Abaissementdunez',				value = 0,		min = 0,	zoomOffset = 0.6,		camOffset = 0.65},
	{label = "Abaissement pic du nez",					name = 'Abaissementpicdunez',				value = 0,		min = 0,	zoomOffset = 0.6,		camOffset = 0.65},
	{label = "Torsion du nez",					name = 'Torsiondunez',				value = 0,		min = 0,	zoomOffset = 0.6,		camOffset = 0.65},
	{label = "Hauteur sourcils",					name = 'Hauteursourcils',				value = 0,		min = 0,	zoomOffset = 0.6,		camOffset = 0.65},
	{label = "Profondeur sourcils",					name = 'Profondeursourcils',				value = 0,		min = 0,	zoomOffset = 0.6,		camOffset = 0.65},
	{label = "Hauteur des pommettes",					name = 'Hauteurdespommettes',				value = 0,		min = 0,	zoomOffset = 0.6,		camOffset = 0.65},
	{label = "Largeur des pommettes",					name = 'Largeurdespommettes',				value = 0,		min = 0,	zoomOffset = 0.6,		camOffset = 0.65},
	{label = "Largeur des joues",					name = 'Largeurdesjoues',				value = 0,		min = 0,	zoomOffset = 0.6,		camOffset = 0.65},
	{label = "Ouverture des yeux",					name = 'Ouverturedesyeux',				value = 0,		min = 0,	zoomOffset = 0.6,		camOffset = 0.65},
	{label = "Epaisseur des levres",					name = 'Epaisseurdeslevres',				value = 0,		min = 0,	zoomOffset = 0.6,		camOffset = 0.65},
	{label = "Largeur de la machoire",					name = 'Largeurdelamachoire',				value = 0,		min = 0,	zoomOffset = 0.6,		camOffset = 0.65},
	{label = "Longueur du dos de la machoire",					name = 'Longueurdudosdelamachoire',				value = 0,		min = 0,	zoomOffset = 0.6,		camOffset = 0.65},
	{label = "Abaissement du menton",					name = 'Abaissementdumenton',				value = 0,		min = 0,	zoomOffset = 0.6,		camOffset = 0.65},
	{label = "Longueur de l'os du menton",					name = 'Longueurdelosdumenton',				value = 0,		min = 0,	zoomOffset = 0.6,		camOffset = 0.65},
	{label = "Largeur du menton",					name = 'Largeurdumenton',				value = 0,		min = 0,	zoomOffset = 0.6,		camOffset = 0.65},
	{label = "Trou du menton",					name = 'Troudumenton',				value = 0,		min = 0,	zoomOffset = 0.6,		camOffset = 0.65},
	{label = "Epaisseur du cou",					name = 'Epaisseurducou',				value = 0,		min = 0,	zoomOffset = 0.6,		camOffset = 0.65},
...
function GetMaxVals()
	...
	local data = {
		...
		Longueurnez			= 40,
		Abaissementdunez			= 40,
		Abaissementpicdunez			= 40,
		Torsiondunez			= 40,
		Hauteursourcils			= 40,
		Profondeursourcils			= 40,
		Hauteurdespommettes			= 40,
		Largeurdespommettes			= 40,
		Largeurdesjoues			= 40,
		Ouverturedesyeux			= 40,
		Epaisseurdeslevres			= 40,
		Largeurdelamachoire			= 40,
		Longueurdudosdelamachoire			= 40,
		Abaissementdumenton			= 40,
		Longueurdelosdumenton			= 40,
		Largeurdumenton			= 40,
		Troudumenton			= 40,
		Epaisseurducou			= 40,
...
function ApplySkin(skin, clothes)
	...
	if clothes ~= nil then
		for k,v in pairs(clothes) do
			if
				...
				k ~= 'Hauteurnez'				and
				k ~= 'Longueurnez'				and
				k ~= 'Abaissementdunez'				and
				k ~= 'Abaissementpicdunez'				and
				k ~= 'Torsiondunez'				and
				k ~= 'Hauteursourcils'				and
				k ~= 'Profondeursourcils'				and
				k ~= 'Hauteurdespommettes'				and
				k ~= 'Largeurdespommettes'				and
				k ~= 'Largeurdesjoues'				and
				k ~= 'Ouverturedesyeux'				and
				k ~= 'Epaisseurdeslevres'				and
				k ~= 'Largeurdelamachoire'				and
				k ~= 'Longueurdudosdelamachoire'				and
				k ~= 'Abaissementdumenton'				and
				k ~= 'Longueurdelosdumenton'				and
				k ~= 'Largeurdumenton'				and
				k ~= 'Troudumenton'				and
				k ~= 'Epaisseurducou'				and
				k ~= 'skin'				and
				k ~= 'age_1'			and
				k ~= 'age_2'			and
				k ~= 'eye_color'		and
	...
	SetPedComponentVariation(playerPed, 0, Character['facepeds'],			Character['facepeds2'], 0)

	SetPedFaceFeature(playerPed, 0, Character['Largeurnez']/ 40 * 2-1)
	SetPedFaceFeature(playerPed, 1, Character['Hauteurnez']/ 40 * 2-1)
	SetPedFaceFeature(playerPed, 2, Character['Longueurnez']/ 40 * 2-1)
	SetPedFaceFeature(playerPed, 3, Character['Abaissementdunez']/ 40 * 2-1)
	SetPedFaceFeature(playerPed, 4, Character['Abaissementpicdunez']/ 40 * 2-1)
	SetPedFaceFeature(playerPed, 5, Character['Torsiondunez']/ 40 * 2-1)
	SetPedFaceFeature(playerPed, 6, Character['Hauteursourcils']/ 40 * 2-1)
	SetPedFaceFeature(playerPed, 7, Character['Profondeursourcils']/ 40 * 2-1)
	SetPedFaceFeature(playerPed, 8, Character['Hauteurdespommettes']/ 40 * 2-1)
	SetPedFaceFeature(playerPed, 9, Character['Largeurdespommettes']/ 40 * 2-1)
	SetPedFaceFeature(playerPed, 10, Character['Largeurdesjoues']/ 40 * 2-1)
	SetPedFaceFeature(playerPed, 11, Character['Ouverturedesyeux']/ 40 * 2-1)
	SetPedFaceFeature(playerPed, 12, Character['Epaisseurdeslevres']/ 40 * 2-1)
	SetPedFaceFeature(playerPed, 13, Character['Largeurdelamachoire']/ 40 * 2-1)
	SetPedFaceFeature(playerPed, 14, Character['Longueurdudosdelamachoire']/ 40 * 2-1)
	SetPedFaceFeature(playerPed, 15, Character['Abaissementdumenton']/ 40 * 2-1)
	SetPedFaceFeature(playerPed, 16, Character['Longueurdelosdumenton']/ 40 * 2-1)
	SetPedFaceFeature(playerPed, 17, Character['Largeurdumenton']/ 40 * 2-1)
	SetPedFaceFeature(playerPed, 18, Character['Troudumenton']/ 40 * 2-1)
	SetPedFaceFeature(playerPed, 19, Character['Epaisseurducou']/ 40 * 2-1)
