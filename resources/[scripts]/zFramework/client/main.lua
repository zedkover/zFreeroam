...
AddEventHandler('esx:addInventoryItem', function(item, count)
	...
	if ESX.UI.Menu.IsOpen('default', 'zFramework', 'inventory') then
		ESX.ShowInventory()
	end
end)
...
-- Citizen.CreateThread(function()
	-- while true do
		...
		-- if IsControlPressed(0, Keys1['F2'] ,keys2 ['A']) and IsInputDisabled(0) and not isDead and not ESX.UI.Menu.IsOpen('default', 'zFramework', 'inventory') then
			-- ESX.ShowInventory()
		-- end
