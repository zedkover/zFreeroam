function CreateExtendedPlayer(player, accounts, inventory, loadout, name, lastPosition)
	...
	self.setMoney = function(money)
		...
		if money >= 0 then
			...
			print(('zFramework: %s attempted exploiting! (reason: player tried setting -1 cash balance)'):format(self.identifier))
	...
	self.setBankBalance = function(money)
		...
		if money >= 0 then
			...
			print(('zFramework: %s attempted exploiting! (reason: player tried setting -1 bank balance)'):format(self.identifier))
	...
	self.addMoney = function(money)
		...
		if money >= 0 then
			...
			print(('zFramework: %s attempted exploiting! (reason: player tried adding -1 cash balance)'):format(self.identifier))
	...
	self.removeMoney = function(money)
		...
		if money >= 0 then
			...
			print(('zFramework: %s attempted exploiting! (reason: player tried removing -1 cash balance)'):format(self.identifier))
	...
	self.addBank = function(money)
		...
		if money >= 0 then
			...
			print(('zFramework: %s attempted exploiting! (reason: player tried adding -1 bank balance)'):format(self.identifier))
	...
	self.removeBank = function(money)
		...
		if money >= 0 then
			...
			print(('zFramework: %s attempted exploiting! (reason: player tried removing -1 bank balance)'):format(self.identifier))
	...
	self.setAccountMoney = function(acc, money)
		...
		if money < 0 then
			...
			print(('zFramework: %s attempted exploiting! (reason: player tried setting -1 account balance)'):format(self.identifier))
	...
	self.addAccountMoney = function(acc, money)
		...
		if money < 0 then
			...
			print(('zFramework: %s attempted exploiting! (reason: player tried adding -1 account balance)'):format(self.identifier))
	...
	self.removeAccountMoney = function(a, m)
		...
		if m < 0 then
			...
			print(('zFramework: %s attempted exploiting! (reason: player tried removing -1 account balance)'):format(self.identifier))
